...
$args_filter = ['sair_page_protected' => FILTER_SANITIZE_STRING, 'username' => FILTER_SANITIZE_STRING, 'userpassword' => FILTER_SANITIZE_STRING];
...
if (isset($lock_form['sair_page_protected']) && $lock_form['sair_page_protected'] === 'sair') {
    $Lock->logout();
} elseif ( isset($lock_form['username']) && isset($lock_form['userpassword'])) {
